...
public class shootingZombieII : MonoBehaviour
{
    ...
    {
        s = Mathf.Abs(transform.position.x - charrecter.transform.position.x) + (charrecter.transform.position.y - transform.position.y)*0.8f;
        isAttacking = true;
